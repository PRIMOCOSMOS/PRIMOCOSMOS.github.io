...
### Workstation scaffold revision (2026-09-14)
The first view must expose principal network operations as correctly shaped tensor planes, inspired by TensorSpace.js. Remove abstract group-counter boxes. Deep views elaborate mathematical operations while preserving crystal art and directional animation. Use a three-root, task-family, module catalog; keep searchable navigation. Preserve source-accurate numerical execution and avoid sampling.
