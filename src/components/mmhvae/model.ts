...
export type Kind = 'input' | 'stem' | 'encoder' | 'down' | 'expert' | 'prior' | 'poe' | 'sample' | 'up' | 'decoder' | 'lift' | 'output' | 'resnet' | 'image' | 'discriminator'
