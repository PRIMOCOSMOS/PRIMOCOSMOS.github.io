...
function App() {
  const [activePaper, setActivePaper] = useState<PaperId>('mmhvae')

  const selectPaper = (paper: PaperId) => setActivePaper(paper)
  ...
  return (
    <>
      <header className="site-header">
        <a className="brand" href="#home" aria-label="返回 PRIMOCOSMOS 个人主页封面">
          <BrandMark />
          <span>PRIMOCOSMOS</span>
        </a>
        <nav aria-label="主导航">
          <a href="#home">主页</a>
          <a href="#research">科研笔记</a>
        </nav>
        <div className="link-status"><span /> FIELD ONLINE</div>
      </header>

      <main id="main-content">
        <section className="personal-cover" id="home" aria-labelledby="cover-title">
          <SignalField />
          <div className="cover-grid">
            <div className="cover-identity">
              <div className="coordinate-line"><span>PERSONAL HOMEPAGE</span><span>31.2304° N</span></div>
            ...
            <aside className="cover-console" aria-label="个人主页索引">
              <div className="telemetry-heading"><Radio size={16} /> PERSONAL FIELD INDEX</div>
              <div className="identity-seal" aria-hidden="true"><BrandMark /><span>P</span></div>
              <dl>
                <div><dt>Current axis</dt><dd>qMRI · MULTIMODAL LEARNING</dd></div>
                <div><dt>Open archive</dt><dd>RESEARCH NOTES / 003</dd></div>
                <div><dt>Working mode</dt><dd>READ · MODEL · VERIFY</dd></div>
              </dl>
              <div className="console-frequency"><span>02.718</span><i /></div>
            </aside>
          </div>

          <div className="cover-index" aria-label="个人主页板块状态">
            <div className="is-open"><span>01</span><strong>Research</strong><small>OPEN</small></div>
            <div><span>02</span><strong>Projects</strong><small>RESERVED</small></div>
            <div><span>03</span><strong>Profile</strong><small>RESERVED</small></div>
          </div>
        </section>
